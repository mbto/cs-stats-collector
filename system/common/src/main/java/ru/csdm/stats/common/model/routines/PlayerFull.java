...
public class PlayerFull extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1115030531;

    /**
     * The parameter <code>csstats.player_full.id</code>.
     */
     ...
     */
    public PlayerFull() {
        super("player_full", Csstats.CSSTATS);
