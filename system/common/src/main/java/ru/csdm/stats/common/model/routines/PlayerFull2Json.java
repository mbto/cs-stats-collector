...
public class PlayerFull2Json extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -133362990;

    /**
     * The parameter <code>csstats.player_full2_json.id</code>.
     */
    ...
    public PlayerFull2Json() {
        super("player_full2_json", Csstats.CSSTATS);
