...
public class Playersummary extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -864778798;

    /**
     * The parameter <code>csstats.PlayerSummary.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerSummary.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerSummary.per_page</code>.
     */
    ...
    public Playersummary() {
        super("PlayerSummary", Csstats.CSSTATS);
