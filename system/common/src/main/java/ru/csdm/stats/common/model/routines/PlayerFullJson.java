...
public class PlayerFullJson extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = 2054464296;

    /**
     * The parameter <code>csstats.player_full_json.id</code>.
     */
    ...
    public PlayerFullJson() {
        super("player_full_json", Csstats.CSSTATS);
