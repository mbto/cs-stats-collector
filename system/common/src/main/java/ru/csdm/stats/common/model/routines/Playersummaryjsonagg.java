...
public class Playersummaryjsonagg extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1953582089;

    /**
     * The parameter <code>csstats.PlayerSummaryJsonAgg.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerSummaryJsonAgg.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerSummaryJsonAgg.per_page</code>.
     */
     ...
     */
    public Playersummaryjsonagg() {
        super("PlayerSummaryJsonAgg", Csstats.CSSTATS);
