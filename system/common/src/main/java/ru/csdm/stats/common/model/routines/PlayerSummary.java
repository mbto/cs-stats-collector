...
public class PlayerSummary extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = 142257612;

    /**
     * The parameter <code>csstats.player_summary.id</code>.
     */
    ...
    public PlayerSummary() {
        super("player_summary", Csstats.CSSTATS);
