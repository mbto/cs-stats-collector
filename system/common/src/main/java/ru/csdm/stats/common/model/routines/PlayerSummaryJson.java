...
public class PlayerSummaryJson extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1881052459;

    /**
     * The parameter <code>csstats.player_summary_json.id</code>.
     */
    ...
    public PlayerSummaryJson() {
        super("player_summary_json", Csstats.CSSTATS);
