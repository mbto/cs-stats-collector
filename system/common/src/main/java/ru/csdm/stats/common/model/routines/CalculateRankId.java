...
public class CalculateRankId extends AbstractRoutine<UInteger> {
    ...
    private static final long serialVersionUID = 250739232;

    /**
     * The parameter <code>csstats.calculate_rank_id.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>csstats.calculate_rank_id.kills</code>.
     */
    ...
    /**
     * The parameter <code>csstats.calculate_rank_id.deaths</code>.
     */
    ...
    /**
     * The parameter <code>csstats.calculate_rank_id.time_secs</code>.
     */
    ...
    public CalculateRankId() {
        super("calculate_rank_id", Csstats.CSSTATS, org.jooq.impl.SQLDataType.INTEGERUNSIGNED);
