...
public class Playerfulljsonagg extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -2042462442;

    /**
     * The parameter <code>csstats.PlayerFullJsonAgg.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerFullJsonAgg.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerFullJsonAgg.per_page</code>.
     */
     ...
     */
    public Playerfulljsonagg() {
        super("PlayerFullJsonAgg", Csstats.CSSTATS);
