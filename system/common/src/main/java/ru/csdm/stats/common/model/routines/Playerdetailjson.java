...
public class Playerdetailjson extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1367922897;

    /**
     * The parameter <code>csstats.PlayerDetailJson.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerDetailJson.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerDetailJson.per_page</code>.
     */
    ...
    public Playerdetailjson() {
        super("PlayerDetailJson", Csstats.CSSTATS);
