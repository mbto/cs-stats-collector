...
import ru.csdm.stats.common.model.csstats.tables.records.*;
...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<HistoryRecord, PlayerRecord> HISTORY_PLAYER_ID_FK = Internal.createForeignKey(ru.csdm.stats.common.model.csstats.Keys.KEY_PLAYER_PRIMARY, History.HISTORY, "history_player_id_fk", History.HISTORY.PLAYER_ID);
        public static final ForeignKey<HistoryRecord, RankRecord> HISTORY_OLD_RANK_ID_FK = Internal.createForeignKey(ru.csdm.stats.common.model.csstats.Keys.KEY_RANK_PRIMARY, History.HISTORY, "history_old_rank_id_fk", History.HISTORY.OLD_RANK_ID);
        public static final ForeignKey<HistoryRecord, RankRecord> HISTORY_NEW_RANK_ID_FK = Internal.createForeignKey(ru.csdm.stats.common.model.csstats.Keys.KEY_RANK_PRIMARY, History.HISTORY, "history_new_rank_id_fk", History.HISTORY.NEW_RANK_ID);
        public static final ForeignKey<PlayerRecord, RankRecord> PLAYER_RANK_ID_FK = Internal.createForeignKey(ru.csdm.stats.common.model.csstats.Keys.KEY_RANK_PRIMARY, Player.PLAYER, "player_rank_id_fk", Player.PLAYER.RANK_ID);
        public static final ForeignKey<PlayerIpRecord, PlayerRecord> PLAYER_IP_PLAYER_ID_FK = Internal.createForeignKey(ru.csdm.stats.common.model.csstats.Keys.KEY_PLAYER_PRIMARY, PlayerIp.PLAYER_IP, "player_ip_player_id_fk", PlayerIp.PLAYER_IP.PLAYER_ID);
        public static final ForeignKey<PlayerSteamidRecord, PlayerRecord> PLAYER_STEAMID_PLAYER_ID_FK = Internal.createForeignKey(ru.csdm.stats.common.model.csstats.Keys.KEY_PLAYER_PRIMARY, PlayerSteamid.PLAYER_STEAMID, "player_steamid_player_id_fk", PlayerSteamid.PLAYER_STEAMID.PLAYER_ID);
    }
}
