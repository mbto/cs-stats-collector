...
public class Playerhistoryjsonagg extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 1338195842;

    /**
     * The parameter <code>csstats.PlayerHistoryJsonAgg.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerHistoryJsonAgg.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerHistoryJsonAgg.per_page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerHistoryJsonAgg.history_limit</code>.
     */
    public static final Parameter<UInteger> HISTORY_LIMIT = Internal.createParameter("history_limit", org.jooq.impl.SQLDataType.INTEGERUNSIGNED, false, false);

    /**
     * Create a new routine call instance
     */
    public Playerhistoryjsonagg() {
        super("PlayerHistoryJsonAgg", Csstats.CSSTATS);
    ...
    /**
     * Set the <code>history_limit</code> parameter IN value to the routine
     */
    public void setHistoryLimit(UInteger value) {
        setValue(HISTORY_LIMIT, value);
    }
}
