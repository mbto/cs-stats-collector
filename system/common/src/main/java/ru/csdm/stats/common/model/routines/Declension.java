...
public class Declension extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1154091604;

    /**
     * The parameter <code>csstats.declension.RETURN_VALUE</code>.
     */
     ...
     */
    public Declension() {
        super("declension", Csstats.CSSTATS, org.jooq.impl.SQLDataType.VARCHAR(32));
