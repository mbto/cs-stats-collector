...
public class Playerdetailjsonagg extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = 506282708;

    /**
     * The parameter <code>csstats.PlayerDetailJsonAgg.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerDetailJsonAgg.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerDetailJsonAgg.per_page</code>.
     */
     ...
     */
    public Playerdetailjsonagg() {
        super("PlayerDetailJsonAgg", Csstats.CSSTATS);
