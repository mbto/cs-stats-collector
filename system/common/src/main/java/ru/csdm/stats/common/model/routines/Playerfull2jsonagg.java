...
public class Playerfull2jsonagg extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -972066996;

    /**
     * The parameter <code>csstats.PlayerFull2JsonAgg.id</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerFull2JsonAgg.page</code>.
     */
    ...
    /**
     * The parameter <code>csstats.PlayerFull2JsonAgg.per_page</code>.
     */
     ...
     */
    public Playerfull2jsonagg() {
        super("PlayerFull2JsonAgg", Csstats.CSSTATS);
